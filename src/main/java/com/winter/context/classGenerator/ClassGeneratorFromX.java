...
@Bean
public class ClassGeneratorFromX {
    ...
    public ClassGeneratorFromX(String projectRootPath, String packagePath, List<String> otherClassesImports, Class superClass, List<Class> implInterfaces) {
    ...
    public ClassGeneratorFromX(String projectRootPath, String packagePath, List<String> otherClassesImports, List<Class> implInterfaces) {
        this.projectRootPath = projectRootPath;
        this.packagePath = packagePath;
        this.otherClassesImports = otherClassesImports;
        this.implInterfaces = implInterfaces;
    ...
    public ClassGeneratorFromX(String projectRootPath, String packagePath, List<String> otherClassesImports, Class superClass) {
        this.projectRootPath = projectRootPath;
        this.packagePath = packagePath;
        this.otherClassesImports = otherClassesImports;
        this.superClass = superClass;
    ...
    public ClassGeneratorFromX(String projectRootPath, String packagePath, List<String> otherClassesImports) {
        this.projectRootPath = projectRootPath;
        this.packagePath = packagePath;
        this.otherClassesImports = otherClassesImports;
    }

    public ClassGeneratorFromX(String projectRootPath, String packagePath) {
        this.projectRootPath = projectRootPath;
        this.packagePath = packagePath;
    }

    public ClassGeneratorFromX() {
    ...
    public void generateMoreClasses(List<String> classNames, List<String> params) throws IOException, ClassNotFoundException {
        ...
        if (classNames.size() == params.size()) {
            ClassGeneratorFromX c = new ClassGeneratorFromX(projectRootPath, packagePath, otherClassesImports, superClass, implInterfaces);
